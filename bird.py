...
class Idle:
    ...
    def draw(boy):
        if boy.face_dir == -1:
            boy.image.clip_composite_draw(int(boy.frame) * 180, boy.action * 160, 180, 160, 0, 'h', boy.x, boy.y, 200,
                                          200)
        else:
            boy.image.clip_draw(int(boy.frame) * 180, boy.action * 160, 180, 160, boy.x, boy.y, 200, 200)
